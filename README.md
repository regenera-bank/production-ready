...
**Data de referência dos artefatos:** 26 de junho de 2026  
...
- 1.517 arquivos nas árvores extraídas;
- 1.479 artefatos textuais legíveis entre código, contratos, políticas, schemas, testes, relatórios e evidências;
...
**Evidência da baseline.** 75 arquivos; 25 gates locais reportados, entre compilações, testes de plataforma e governança; dez comandos de plataforma aprovados; 15 testes de governança aprovados; extração limpa e release verificadas. Keystore, Keychain, App Attest, Play Integrity, WAF, identidade corporativa e lojas dependem de plataforma externa.
...
|---:|---|---:|---:|---|---|---|
| `00` | Governance | 72 | 24 | `PASS` | `720c9425a233e1c4cae8d022e6704c6ec212908c9b4a5547f2cb237770f31ee9` | revisão independente e assinatura real |
| `01` | Design System | 88 | 33 | `PASS` | `833477ca7a5b1201a6e89543faf790f7b1a9e55cfed25ea2f4dae5e34df390f5` | revisão independente e assinatura institucional |
| `02` | Contracts | 81 | 33 | `PASS` | `f288a266c7e41806c8cf9df016a2f24afc9e5b36e4b3bfd3de8e36bcda44d1ae` | revisão independente, ticket de mudança e assinatura |
| `03` | Channels | 75 | 25 | `PASS` | `1545c87328e801e03c4139d665331c8cf30148981171bf2a417f55f9068da260` | plataformas, identidade, attestation e assinatura |
| `04` | BFFs | 96 | 47 | `PASS` | `a95c624808f5ee4ddefe04ba21a12b400f16ff04d165de0e60a6f051504e2084` | certificados, IAM, WAF, secret manager e assinatura |
| `05` | Core Banking | 57 | 47 | `PASS` | `1c660fec84adad0a943bfc5e05b816206bc62e6ef331fd0f5d6450c4eafa7d2a` | persistência produtiva, HSM/IAM, homologação e aprovação |
| `06` | Risk Control | 59 | 54 | `PASS` | `6474ce5db094c561eb7a217ad6849e5b339178d932ee3dda7bdeebb2ad68267d` | listas, bureaus, IAM/SIEM e integrações oficiais |
| `07` | Integrations | 95 | 56 | `PASS` | `b6919d7718b5bf8926f4393aa545e2970a9caa2200a6ea57265bdc72007d2389` | contratos, certificados, conectividade e homologação |
| `08` | ISO 20022 | 138 | 48 | `PASS` | `59a1c11876784da8891e3fa2aea8b603a487f7b760b7b3393aa00b7487410eb5` | XSDs oficiais, homologação e assinatura |
| `09` | Data Platform | 131 | 77 | `PASS` | `f736a99806cc15fd416bc3372a021d9dd03a52074c3d2059b222e27ec5499b23` | storage, catálogo, broker, IAM e engines gerenciados |
| `10` | Platform Engineering | 55 | 44 | `PASS` | `dfefb9977e286a94fa055b26573d4f2d5299d42e2c8ea4781643630f243bdf90` | cloud, cluster, HSM/KMS, bancos, SIEM e DR |
| `11` | Security | 61 | 95 | `PASS` | `5f4fcb27b8595696e60fd99ffe637341e81e1ae76975eb50b13bf15203b614af` | HSM, PKI, SIEM/SOC, pentest, red team e attestation |
| `12` | Regulatory | 108 | 133 | `PASS` | `ef598237f39a7de6b1ff63d084192ca1065e05e0496925937ef8641164b143b8` | revisão jurídica, canais oficiais e aprovação institucional |
| `13` | Quality | 69 | 106 | `PASS` | `4ea96899440c9bc22278afb1fc4b6a6aea45c703598555438b4dd5414e2d06b5` | carga externa, dispositivos, pentest e continuidade |
| `14` | Operations | 120 | 111 | `PASS` | `718be96475df0f4223063318e95067d7942f5efec3eebdfd061d02326043f799` | IAM, ITSM, observabilidade, provedores e ambiente de continuidade |
| `15` | Tools | 115 | 134 | `PASS` | `15ca06bc9c72ca6fac5d509160544038ad1d059dae6d3b382ccae0faa0696f03` | CI institucional, IAM, imagens assinadas e signing service |
| `16` | Documentation | 97 | 113 | `PASS` | `4d0b3b9dc9792153ec3abc5808fa1f3801fa18990e4b3d3d232414539b8f11ba` | revisão independente, assinatura e evidências operacionais externas |

**Total:** 1.517 arquivos nas árvores extraídas e 1.180 testes ou verificações reportados.
